                    ...
                    >
                        ...
                        <div className="hidden sm:block">
                            <p className="text-sm font-extrabold tracking-tight text-white flex items-center gap-1.5">
                                ...
                                <span className="text-[9px] uppercase font-extrabold bg-sky-500/20 text-sky-300 px-1.5 py-0.5 rounded-full border border-sky-400/30">Tutor</span>
                            </p>

                            <p className="text-[9px] font-semibold uppercase tracking-widest text-sky-200/70">
                                Cisco NetAcad Educator Portal
                            </p>
                        </div>
                    </Link>
                </div>
